...
void graphics_mode(void) {
    ...
    outb(0x3C8, 2);
    outb(0x3C9, 0); outb(0x3C9, 42); outb(0x3C9, 0);

    outb(0x3C8, 3);
    outb(0x3C9, 0); outb(0x3C9, 42); outb(0x3C9, 42);

    outb(0x3C8, 4);
    outb(0x3C9, 42); outb(0x3C9, 0); outb(0x3C9, 0);

    outb(0x3C8, 5);
    outb(0x3C9, 42); outb(0x3C9, 0); outb(0x3C9, 42);

    outb(0x3C8, 6);
    outb(0x3C9, 42); outb(0x3C9, 21); outb(0x3C9, 0);

    outb(0x3C8, 7);
    outb(0x3C9, 42); outb(0x3C9, 42); outb(0x3C9, 42);

    outb(0x3C8, 8);
    outb(0x3C9, 21); outb(0x3C9, 21); outb(0x3C9, 21);

    outb(0x3C8, 9);
    outb(0x3C9, 21); outb(0x3C9, 21); outb(0x3C9, 63);

    outb(0x3C8, 10);
    outb(0x3C9, 21); outb(0x3C9, 63); outb(0x3C9, 21);

    outb(0x3C8, 11);
    outb(0x3C9, 21); outb(0x3C9, 63); outb(0x3C9, 63);

    outb(0x3C8, 12);
    outb(0x3C9, 63); outb(0x3C9, 21); outb(0x3C9, 21);

    outb(0x3C8, 13);
    outb(0x3C9, 63); outb(0x3C9, 21); outb(0x3C9, 63);

    outb(0x3C8, 14);
    outb(0x3C9, 63); outb(0x3C9, 63); outb(0x3C9, 21);
...
void put_pixel(int x, int y, int color) {
    ...
    volatile uint8_t dummy = vga[offset];
    (void)dummy;
